import { l as useData } from "./client.C4C2pNNb.js";
import { ssrInterpolate, ssrRenderAttrs, ssrRenderStyle } from "vue/server-renderer";
import { unref, useSSRContext } from "vue";
//#region api-examples.md
var __pageData = JSON.parse("{\"title\":\"Runtime API Examples\",\"description\":\"\",\"frontmatter\":{\"outline\":\"deep\"},\"headers\":[],\"relativePath\":\"api-examples.md\",\"filePath\":\"api-examples.md\"}");
var _sfc_main = /*@__PURE__*/ Object.assign({ name: "api-examples.md" }, {
	__ssrInlineRender: true,
	setup(__props) {
		const { site, theme, page, frontmatter } = useData();
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(_attrs)}><h1 id="runtime-api-examples" tabindex="-1">Runtime API Examples <a class="header-anchor" href="#runtime-api-examples" aria-label="Permalink to “Runtime API Examples”">​</a></h1><p>This page demonstrates usage of some of the runtime APIs provided by VitePress.</p><p>The main <code>useData()</code> API can be used to access site, theme, and page data for the current page. It works in both <code>.md</code> and <code>.vue</code> files:</p><div class="language-md"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki shiki-themes github-light github-dark" style="${ssrRenderStyle({
				"--shiki-light": "#24292e",
				"--shiki-dark": "#e1e4e8",
				"--shiki-light-bg": "#fff",
				...
				"--shiki-light": "#24292E",
				"--shiki-dark": "#E1E4E8"
			})}">&lt;script setup&gt;</span></span>
<span class="line"><span style="${ssrRenderStyle({
				"--shiki-light": "#24292E",
				"--shiki-dark": "#E1E4E8"
			})}">import { useData } from &#39;vitepress&#39;</span></span>
<span class="line"></span>
<span class="line"><span style="${ssrRenderStyle({
				"--shiki-light": "#24292E",
				"--shiki-dark": "#E1E4E8"
			})}">const { theme, page, frontmatter } = useData()</span></span>
<span class="line"><span style="${ssrRenderStyle({
				"--shiki-light": "#24292E",
				"--shiki-dark": "#E1E4E8"
			})}">&lt;/script&gt;</span></span>
...
<span class="line"><span style="${ssrRenderStyle({
				...
				"--shiki-dark": "#79B8FF",
				"--shiki-dark-font-weight": "bold"
			})}">### Theme Data</span></span>
<span class="line"><span style="${ssrRenderStyle({
				"--shiki-light": "#24292E",
				"--shiki-dark": "#E1E4E8"
			})}">&lt;pre&gt;{{ theme }}&lt;/pre&gt;</span></span>
<span class="line"></span>
<span class="line"><span style="${ssrRenderStyle({
				"--shiki-light": "#005CC5",
				"--shiki-light-font-weight": "bold",
