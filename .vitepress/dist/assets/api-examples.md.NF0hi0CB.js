import { E as openBlock, O as unref, b as createStaticVNode, h as useData, k as toDisplayString, v as createBaseVNode, x as createTextVNode, y as createElementBlock } from "./chunks/framework.BmVEnEPd.js";
...
var _sfc_main = /*@__PURE__*/ Object.assign({ name: "api-examples.md" }, { setup(__props) {
	...
	return (_ctx, _cache) => {
		return openBlock(), createElementBlock("div", null, [
			...
			_cache[1] || (_cache[1] = createBaseVNode("h3", {
				id: "page-data",
				tabindex: "-1"
			}, [createTextVNode("Page Data "), createBaseVNode("a", {
				class: "header-anchor",
				href: "#page-data",
			...
			_cache[2] || (_cache[2] = createBaseVNode("h3", {
				id: "page-frontmatter",
				tabindex: "-1"
			}, [createTextVNode("Page Frontmatter "), createBaseVNode("a", {
				class: "header-anchor",
			...
			_cache[3] || (_cache[3] = createBaseVNode("h2", {
				id: "more",
				tabindex: "-1"
			}, [createTextVNode("More "), createBaseVNode("a", {
				class: "header-anchor",
				href: "#more",
